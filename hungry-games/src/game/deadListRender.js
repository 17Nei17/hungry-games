...
function DeadListRender(props) {
    return (
        <div className="">
            ...
            {props.deadCharactersListAfterDay.length > 0 && props.deadCharactersListAfterDay.map(element => {
                return (
            ...
            {props.deadCharactersListAfterDay.length == 0 && <div>Никто не погиб за минувшие сутки</div>}
            <button
                onClick={() => {
                    props.nextDay();
                }}
